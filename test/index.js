...
etape(__dirname+'/client-index.js', function (tape, window) {

  var ipcStream1 = pullipc('s1', ipc, window, function (err) {
    console.log('ipc-stream 1 ended', err)
  })
  var ipcStream2 = pullipc('s2', ipc, window, function (err) {
    console.log('ipc-stream 2 ended', err)
  })
  var ipcStream3 = pullipc('s3', ipc, window, function (err) {
